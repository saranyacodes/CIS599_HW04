...
abstract class Drawable {
  ...
  //add transform matrices
  matricesGenerated: boolean = false; 
  ...
  destory() {
    ...
    gl.deleteBuffer(this.bufMat);
    gl.deleteBuffer(this.bufUV);
    gl.deleteBuffer(this.bufMatrices); //added 
  }
  ...
  generateMatrices() {
    ...
    this.bufMatrices = gl.createBuffer(); 
  }
  ...
  bindUV(): boolean {
    ...
    //added 
    bindMatrices(): boolean {
      if (this.matricesGenerated) {
        gl.bindBuffer(gl.ARRAY_BUFFER, this.bufMatrices);
      }
